...
function generateStyles(config = {}) {
  ...
  try {
    ...
    console.log(
      `${getTimeStamp()} No configuration file found at ${configPath}!`,
    );
    return;
  }
  const { inputStyles, inputFiles, outputStyles, module } = config;
  ...
  function generateOutput(changedFilePath = null) {
    ...
    const output = module ? "export const styles = " : "const styles = ";
...
module.exports = { generateStyles, getTimeStamp };
